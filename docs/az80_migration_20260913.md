...
| **c3-sdc** | **+0.461** | 20.64 | 24.23 | ★★clk21m→az80 `set_max_delay 46.566`로 실요구 명시. slow/fast 8항목 전부 양수 — 배포 `MSX1_20260914b_azfix.rbf` |
...
- [ ] **실기 2차**(`20260914b_azfix`): 3.58 부팅 → 10.7 게임 → 21.5 Z80BENCH → 3↔4 전환 리셋 → 3.58 SCC/OPLL 곡
