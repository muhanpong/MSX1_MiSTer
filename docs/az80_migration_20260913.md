...
| **d_azturbo** | **3.57** | **5.36** | **7.16** | **10.74** | (21.48) |
...
### ◆◆◆ Z80BENCH 전 속도 공칭 일치 (20260915, `MSX1_20260915d_azturbo.rbf`)
사용자 실측: **3.58→3.57 / 5.37→5.36 / 7.16→7.16 / 10.7→10.74** — A-Z80 전 속도가 T80s 시절 스톡 기준치와 일치.
이로써 A-Z80 경로는 부팅(20260915a) + 사이클 정확 속도(d)까지 실기 확인. 남은 건 게임·음원 회귀와 OSD 통과 전환 확인.
...
- [ ] OSD 한 번 열어 10.7→21.5→3.58 통과 시 무리셋 확인 (d에 포함, 미확인)
