...
module tb_pipeline_scaffold;
    ...
    initial begin
        ...
        // Sequencer issues 3 mem_rd_en pulses during fc 64..127 in the common
        // (contiguous) case — adaptive burst: 3-word A-window covers a0,a1,a2
        // and the adjacent b0,b1.  (Loop wraps would add a 4th word.)
        @(posedge clk);
        ...
        begin
            ...
            check("Stage B sequencer issued 3 SDRAM word reads (contiguous) in slot 0 window",
                  rd_high_cnt == 3);
        end
