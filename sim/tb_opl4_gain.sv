...
`else
      case (sel)
         3'd1: fm_gain = 12'd51;
         3'd2: fm_gain = 12'd32;
         3'd3: fm_gain = 12'd128;
         3'd4: fm_gain = 12'd203;
         default: fm_gain = 12'd81;
      endcase
`endif
   endfunction
   ...
   initial begin
      // menu order: FM  { 0dB, -4dB, -8dB, +4dB, +8dB }  net vs unity
      fm_want[0] = -3.98; fm_want[1] = -8.00; fm_want[2] = -12.04;
      fm_want[3] =  0.00; fm_want[4] =  +4.02;
