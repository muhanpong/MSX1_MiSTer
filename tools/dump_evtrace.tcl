...
# 8192 x 80) over JTAG.  usage: quartus_stp -t tools/dump_evtrace.tcl
...
if {[catch {
    ...
    set data [read_content_from_memory -instance_index $target -start_address 0 -word_count 8192 -content_in_hex]
    end_memory_edit
